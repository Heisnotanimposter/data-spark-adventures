    ...
    <footer className="border-t py-8 mt-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-semibold mb-4">DataSpark</h3>
            <p className="text-sm text-muted-foreground">
              Empowering data exploration and visualization for everyone, regardless of technical expertise.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-muted-foreground hover:text-primary">Tutorials</a></li>
